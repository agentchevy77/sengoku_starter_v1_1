...
from optipanel.alerts.engine import gen_alerts, analyze_batch, DEFAULT_THRESH

BULL = dict(
    last=105.0, dma20=100.0, support=101.0, resistance=106.0,
    rvol=1.6, rs_strength=0.30, vwap_diff=0.012,
)
BEAR = dict(
    last=95.0, dma20=100.0, support=96.0, resistance=100.0,
