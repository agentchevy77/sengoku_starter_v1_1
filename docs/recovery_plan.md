...
- ✅ **Baseline restored:** `SENGOKU_TEST_SCOPE=full pytest -v --tb=short` now reports **751 passed / 12 skipped / 0 failed** with total coverage at **85.9 %**. Verbose mode is required in this environment to avoid buffered output appearing as a hang.
